  ...
  <Container >
    ...
    <Navbar.Collapse id="basic-navbar-nav">
      <Nav className=" ms-auto mt-3">
        <Nav.Link as={Link} className=" text-danger mx-2 " to="/home">Home</Nav.Link>
        <Nav.Link as={Link} className="" to="/about-us">About Us</Nav.Link>
        <Nav.Link as={Link} className="mx-2" to="/all-services">Services</Nav.Link>
        <Nav.Link as={Link} className="mx-2" to="/event">Sports Event</Nav.Link>
        <Nav.Link as={Link} className="mx2" to="/contact-us">Contact Us</Nav.Link>
