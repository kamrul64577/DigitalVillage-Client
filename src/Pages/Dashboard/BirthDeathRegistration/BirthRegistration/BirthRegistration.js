...
const BirthRegistration = () => {
    ...
    const handleAddBirth = e => {
        Axios.post('https://shielded-falls-80975.herokuapp.com/?fbclid=IwAR1FF8lEw2wPTmrGRnMN37kzdExjiuEfmvMj04E4QWHkn8EQJeo0xVgtU4g/birth', {
            birthInfo,
            value
        ...
        alert('Birth Registration successfull')
        e.preventDefault();
    }
