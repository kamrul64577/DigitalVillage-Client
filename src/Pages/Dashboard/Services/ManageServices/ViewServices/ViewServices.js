...
const ViewServices = () => {
    ...
    useEffect(() => {
        fetch(`https://shielded-falls-80975.herokuapp.com/?fbclid=IwAR1FF8lEw2wPTmrGRnMN37kzdExjiuEfmvMj04E4QWHkn8EQJeo0xVgtU4g/services`)
            .then(res => res.json())
    ...
    const handleDeleteService = id => {
        ...
        if (proceed) {
            const url = `https://shielded-falls-80975.herokuapp.com/?fbclid=IwAR1FF8lEw2wPTmrGRnMN37kzdExjiuEfmvMj04E4QWHkn8EQJeo0xVgtU4g/services/${id}`;
            fetch(url, {
                method: 'DELETE'
            })
                .then(res => res.json())
